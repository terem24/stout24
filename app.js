        ...
        container.innerHTML = `
            <div style="text-align: center; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
                ...
                <input type="text" id="sub_name" placeholder="Имя и фамилия" value="${user.name || user.first_name || ''}" 
                    style="width: 100%; height: 55px; border: 1px solid #e5e5e5; border-radius: 10px; padding: 0; margin: 0 auto 12px auto; font-size: 16px; text-align: center; background: #fff; box-sizing: border-box; display: block;">
                ...
                <input type="tel" id="sub_phone" placeholder="Номер телефона" value="${user.phone || ''}" 
                    style="width: 100%; height: 55px; border: 1px solid #e5e5e5; border-radius: 10px; padding: 0; margin: 0 auto 25px auto; font-size: 16px; text-align: center; background: #fff; box-sizing: border-box; display: block;">
