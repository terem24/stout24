        ...
        const flushBill = (title, warn) => {
            ...
            bill.forEach((i, arrIndex) => {
                ...
                if (i.availability === 'in_stock') {
                    ...
                    availText = '<br><br><b>Статус:</b> <span style="color:#22c55e;">В наличии</span>';
                } else if (i.availability === 'on_order') {
                    availStyle = 'color: #ef4444; border-color: #ef4444;';
                    availText = '<br><br><b>Статус:</b> <span style="color:#ef4444;">Под заказ</span>';
                }
                
                let finalTip = i.qtyTip ? i.qtyTip + availText : (availText ? availText.replace('<br><br>', '') : '');
                let tipHtml = finalTip ? `<div class="tooltip-wrapper"><div class="info-icon" style="${availStyle}">i</div><div class="tooltip-content">${finalTip}</div></div>` : "";
