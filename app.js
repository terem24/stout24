...
const app = {
    ...
    init: function () {
        try {
            ...
            // Проверка наличия каталога перед инициализацией альтернатив
            if (typeof catalog !== 'undefined') {
                ...
                console.error("Catalog is not loaded! Some features may be broken.");
            }
            ...
            // Скрываем прелоадер после полной инициализации (даже если была ошибка)
            setTimeout(() => {
