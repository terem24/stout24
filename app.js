...
const app = {
    ...
    animateNumber: function(obj, start, end, duration) {
        ...
        const step = (timestamp) => {
            ...
            // Плавное замедление к концу анимации (ease-out cubic)
    ...
    render: function () {
        ...
        if (headerTotals) {
            ...
            if (oldEq !== newEq && elEq) {
                app.animateNumber(elEq, oldEq, newEq, 600); // 600мс для красивого эффекта перелистывания
            ...
            if (isPro) {
                ...
                if (oldWorks !== newWorks && elWorks) {
                    app.animateNumber(elWorks, oldWorks, newWorks, 600);
