...
const app = {
    ...
    sendEmail: async function () {
        ...
        // Шаг Б: Отправка Email
        this.render(); // Актуализируем app.lastEqSum, app.lastWorksSum и app.currentSpec
        ...
        try {
            ...
            alert("⚠️ Смета сохранена, но возникла ошибка при отправке Email: " + error.message);
        }
    },
