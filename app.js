    ...
    filterAdminData: function (query) {
        ...
        rows.forEach(row => {
            ...
            renderScheme: function() {
                ...
                if (spec.some(i => i.name.toLowerCase().includes("бак") && (i.name.toLowerCase().includes("отопл") || i.group?.toLowerCase().includes("котельн")) && !i.name.toLowerCase().includes("гвс"))) {
                ...
                if (boilerCount >= 1) {
                    // Если котлов 2 ИЛИ есть потребители (бойлер/системы)
