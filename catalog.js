...
const catalog = {
    ...
    dhw_fittings: [
        ...
        { id: "SVB-0002-000025", name: "Кран шаровой 1\" ВР/ВР (Змеевик бойлера)", price: 1548, rommer: { id: "RBV-0003-0110225", name: "Шаровой кран Rommer 1\" ВН/ВН (бабочка)", price: 860, brand: "ROMMER" } },
        { id: "SFT-0041-000034", name: "Американка 3/4\" ВР/НР (ГВС/Рецирк)", price: 597 },
        { id: "SVB-0012-000020", name: "Кран шаровой 3/4\" ВР/ВР (Бабочка)", price: 865, rommer: { id: "RBV-0003-0110220", name: "Шаровой кран Rommer 3/4\" ВН/ВН (бабочка)", price: 450, brand: "ROMMER" } },
    ...
    chimneys: [
        { id: "SCA-6010-210850", name: "Дымоход коаксиальный 60/100", price: 6298, brand: "STOUT", rommer: { id: "RCA-6010-210850", name: "Комплект коаксиального дымохода ROMMER 60/100", price: 3676, brand: "ROMMER" } }
    ],
    stabs: [
    ...
    tanks_optibase: [
        ...
        { id: "SWH-2110-000150", name: "Бойлер напольный OptiBase 150л", vol: 150, price: 56158, rommer: { id: "RWH-1110-050150", name: "Водонагреватель напольный Rommer 150 л.", price: 59241, brand: "ROMMER" } },
        { id: "SWH-2110-000200", name: "Бойлер напольный OptiBase 200л", vol: 200, price: 62772, rommer: { id: "RWH-1110-050200", name: "Водонагреватель напольный Rommer 200 л.", price: 67462, brand: "ROMMER" } },
        { id: "SWH-2110-000300", name: "Бойлер напольный OptiBase 300л", vol: 300, price: 96910 }
    ],
    tanks_standard: [
        { id: "SWH-3110-000100", name: "Бойлер напольный 100л", vol: 100, price: 57035 },
        { id: "SWH-3110-000150", name: "Бойлер напольный 150л", vol: 150, price: 64046, rommer: { id: "RWH-1110-050150", name: "Водонагреватель напольный Rommer 150 л.", price: 59241, brand: "ROMMER" } },
        { id: "SWH-3110-000200", name: "Бойлер напольный 200л", vol: 200, price: 66729, rommer: { id: "RWH-1110-050200", name: "Водонагреватель напольный Rommer 200 л.", price: 67462, brand: "ROMMER" } },
    ...
    rads: [
        { id: "SRB-0320-050004", name: "Радиатор Space 4 секций", sec: 4, price: 6457, power50: 117, rommer: { id: "RRB-0320-050004", name: "Радиатор биметаллический Rommer Profi 500 (4 секц)", price: 4200, brand: "ROMMER", power50: 117 } },
        { id: "SRB-0320-050005", name: "Радиатор Space 5 секций", sec: 5, price: 7528, power50: 117, rommer: { id: "RRB-0320-050005", name: "Радиатор биметаллический Rommer Profi 500 (5 секц)", price: 5250, brand: "ROMMER", power50: 117 } },
        { id: "SRB-0320-050006", name: "Радиатор Space 6 секций", sec: 6, price: 8599, power50: 117, rommer: { id: "RRB-0320-050006", name: "Радиатор биметаллический Rommer Profi 500 (6 секц)", price: 6300, brand: "ROMMER", power50: 117 } },
        { id: "SRB-0320-050007", name: "Радиатор Space 7 секций", sec: 7, price: 9670, power50: 117, rommer: { id: "RRB-0320-050007", name: "Радиатор биметаллический Rommer Profi 500 (7 секц)", price: 7350, brand: "ROMMER", power50: 117 } },
        { id: "SRB-0320-050008", name: "Радиатор Space 8 секций", sec: 8, price: 10741, power50: 117, rommer: { id: "RRB-0320-050008", name: "Радиатор биметаллический Rommer Profi 500 (8 секц)", price: 8400, brand: "ROMMER", power50: 117 } },
        { id: "SRB-0320-050009", name: "Радиатор Space 9 секций", sec: 9, price: 11812, power50: 117, rommer: { id: "RRB-0320-050009", name: "Радиатор биметаллический Rommer Profi 500 (9 секц)", price: 9450, brand: "ROMMER", power50: 117 } },
        { id: "SRB-0320-050010", name: "Радиатор Space 10 секций", sec: 10, price: 12883, power50: 117, rommer: { id: "RRB-0320-050010", name: "Радиатор биметаллический Rommer Profi 500 (10 секц)", price: 10500, brand: "ROMMER", power50: 117 } },
        { id: "SRB-0320-050011", name: "Радиатор Space 11 секций", sec: 11, price: 13954, power50: 117, rommer: { id: "RRB-0320-050011", name: "Радиатор биметаллический Rommer Profi 500 (11 секц)", price: 11550, brand: "ROMMER", power50: 117 } },
        { id: "SRB-0320-050012", name: "Радиатор Space 12 секций", sec: 12, price: 15025, power50: 117, rommer: { id: "RRB-0320-050012", name: "Радиатор биметаллический Rommer Profi 500 (12 секц)", price: 12600, brand: "ROMMER", power50: 117 } },
        { id: "SRB-0320-050013", name: "Радиатор Space 13 секций", sec: 13, price: 16096, power50: 117, rommer: { id: "RRB-0320-050013", name: "Радиатор биметаллический Rommer Profi 500 (13 секц)", price: 13650, brand: "ROMMER", power50: 117 } },
        { id: "SRB-0320-050014", name: "Радиатор Space 14 секций", sec: 14, price: 17167, power50: 117, rommer: { id: "RRB-0320-050014", name: "Радиатор биметаллический Rommer Profi 500 (14 секц)", price: 14700, brand: "ROMMER", power50: 117 } }
    ],
    ...
    conv_valves: [
        { id: "SVT-0001-000015", name: "Клапан термостатический, прямой 1/2\"", price: 1180, brand: "STOUT", unit: "шт", rommer: { id: "RVT-0001-100015", name: "Клапан термостатический прямой Rommer 1/2\"", price: 470, brand: "ROMMER" } },
        { id: "SVL-1176-000015", name: "Клапан запорно-балансировочный прямой 1/2\"", price: 656, brand: "STOUT", unit: "шт", rommer: { id: "RVL-0001-100015", name: "Клапан запорно-балансировочный прямой Rommer 1/2\"", price: 450, brand: "ROMMER" } },
        { id: "SVT-0005-000015", name: "Клапан термостатический угловой 1/2\"", price: 1614, brand: "STOUT", unit: "шт", rommer: { id: "RVT-0002-100015", name: "Клапан термостатический угловой Rommer 1/2\"", price: 450, brand: "ROMMER" } },
        { id: "SVL-1156-000015", name: "Клапан запорно-балансировочный угловой 1/2\"", price: 597, brand: "STOUT", unit: "шт", rommer: { id: "RVL-0002-100015", name: "Клапан запорно-балансировочный угловой Rommer 1/2\"", price: 430, brand: "ROMMER" } }
    ],
    conv_parts: [
    ...
    heads: [
        { id: "SHT-0001-003015", name: "Головка термостатическая (Газо-жидкостная)", price: 1316, type: 'gas', desc: "Стандартное решение. Быстрая реакция.", rommer: { id: "RHT-0001-103015", name: "Головка термостатическая жидкостная Rommer M30x1,5", price: 620, brand: "ROMMER", type: "liquid" } },
        { id: "SHT-0002-003015", name: "Головка термостатическая (Жидкостная)", price: 1334, type: 'liquid', desc: "Классическая надежная модель.", rommer: { id: "RHT-0001-103015", name: "Головка термостатическая жидкостная Rommer M30x1,5", price: 620, brand: "ROMMER", type: "liquid" } },
    ...
    actuators: { id: "STE-0010-230001", name: "Сервопривод компактный 230В (NC)", price: 2458, rommer: { id: "RTE-0010-230001", name: "Сервопривод термоэлектрический Rommer (NC) 230В", price: 1350, brand: "ROMMER" } },
    ...
    manifolds_rad: [
        { id: "SMS-0922-000002", loops: 2, price: 7643, name: "Коллектор радиаторный 2 вых.", rommer: { id: "RMS-1210-000002", name: "Коллектор радиаторный Rommer 1\"x2 вых.", price: 3500, brand: "ROMMER" } },
        { id: "SMS-0922-000003", loops: 3, price: 9477, name: "Коллектор радиаторный 3 вых.", rommer: { id: "RMS-1210-000003", name: "Коллектор радиаторный Rommer 1\"x3 вых.", price: 4500, brand: "ROMMER" } },
        { id: "SMS-0922-000004", loops: 4, price: 11320, name: "Коллектор радиаторный 4 вых.", rommer: { id: "RMS-1210-000004", name: "Коллектор радиаторный Rommer 1\"x4 вых.", price: 5500, brand: "ROMMER" } },
        { id: "SMS-0922-000005", loops: 5, price: 13418, name: "Коллектор радиаторный 5 вых.", rommer: { id: "RMS-1210-000005", name: "Коллектор радиаторный Rommer 1\"x5 вых.", price: 6500, brand: "ROMMER" } },
        { id: "SMS-0922-000006", loops: 6, price: 15374, name: "Коллектор радиаторный 6 вых.", rommer: { id: "RMS-1210-000006", name: "Коллектор радиаторный Rommer 1\"x6 вых.", price: 7500, brand: "ROMMER" } },
        { id: "SMS-0922-000007", loops: 7, price: 17792, name: "Коллектор радиаторный 7 вых.", rommer: { id: "RMS-1210-000007", name: "Коллектор радиаторный Rommer 1\"x7 вых.", price: 8500, brand: "ROMMER" } },
        { id: "SMS-0922-000008", loops: 8, price: 19985, name: "Коллектор радиаторный 8 вых.", rommer: { id: "RMS-1210-000008", name: "Коллектор радиаторный Rommer 1\"x8 вых.", price: 9500, brand: "ROMMER" } },
        { id: "SMS-0922-000009", loops: 9, price: 21902, name: "Коллектор радиаторный 9 вых.", rommer: { id: "RMS-1210-000009", name: "Коллектор радиаторный Rommer 1\"x9 вых.", price: 10500, brand: "ROMMER" } },
        { id: "SMS-0922-000010", loops: 10, price: 24063, name: "Коллектор радиаторный 10 вых.", rommer: { id: "RMS-1210-000010", name: "Коллектор радиаторный Rommer 1\"x10 вых.", price: 11500, brand: "ROMMER" } },
        { id: "SMS-0922-000011", loops: 11, price: 25961, name: "Коллектор радиаторный 11 вых.", rommer: { id: "RMS-1210-000011", name: "Коллектор радиаторный Rommer 1\"x11 вых.", price: 12500, brand: "ROMMER" } },
        { id: "SMS-0922-000012", loops: 12, price: 27830, name: "Коллектор радиаторный 12 вых.", rommer: { id: "RMS-1210-000012", name: "Коллектор радиаторный Rommer 1\"x12 вых.", price: 13500, brand: "ROMMER" } },
        { id: "SMS-0922-000013", loops: 13, price: 31212, name: "Коллектор радиаторный 13 вых.", rommer: { id: "RMS-1210-000013", name: "Коллектор радиаторный Rommer 1\"x13 вых.", price: 14500, brand: "ROMMER" } }
    ],
    ...
    pipes: [{ id: "SPX-0002-101620", name: "Труба 16x2.0 (100 м)", len: 100, price: 15200, rommer: { id: "RPX-0002-101620", name: "Труба PEX-a Rommer 16x2.0 (100 м)", price: 11500, brand: "ROMMER" } }, { id: "SPX-0002-501620", name: "Труба 16x2.0 (500 м)", len: 500, price: 76000, rommer: { id: "RPX-0002-501620", name: "Труба PEX-a Rommer 16x2.0 (500 м)", price: 57500, brand: "ROMMER" } }],
    insulated_pipes: [
    ...
    manifolds: [
        { id: "SMS-0917-000002", loops: 2, price: 8479, rommer: { id: "RMS-1200-000002", name: "Коллектор с расходомерами Rommer 1\"x2 вых.", price: 3860, brand: "ROMMER" } },
        { id: "SMS-0917-000003", loops: 3, price: 10717, rommer: { id: "RMS-1200-000003", name: "Коллектор с расходомерами Rommer 1\"x3 вых.", price: 4911, brand: "ROMMER" } },
        { id: "SMS-0917-000004", loops: 4, price: 12973, rommer: { id: "RMS-1200-000004", name: "Коллектор с расходомерами Rommer 1\"x4 вых.", price: 6018, brand: "ROMMER" } },
        { id: "SMS-0917-000005", loops: 5, price: 15532, rommer: { id: "RMS-1200-000005", name: "Коллектор с расходомерами Rommer 1\"x5 вых.", price: 7182, brand: "ROMMER" } },
        { id: "SMS-0917-000006", loops: 6, price: 17796, rommer: { id: "RMS-1200-000006", name: "Коллектор с расходомерами Rommer 1\"x6 вых.", price: 8347, brand: "ROMMER" } },
        { id: "SMS-0917-000007", loops: 7, price: 20830, rommer: { id: "RMS-1200-000007", name: "Коллектор с расходомерами Rommer 1\"x7 вых.", price: 9512, brand: "ROMMER" } },
        { id: "SMS-0917-000008", loops: 8, price: 23477, rommer: { id: "RMS-1200-000008", name: "Коллектор с расходомерами Rommer 1\"x8 вых.", price: 10677, brand: "ROMMER" } },
        { id: "SMS-0917-000009", loops: 9, price: 25873, rommer: { id: "RMS-1200-000009", name: "Коллектор с расходомерами Rommer 1\"x9 вых.", price: 11842, brand: "ROMMER" } },
        { id: "SMS-0917-000010", loops: 10, price: 28480, rommer: { id: "RMS-1200-000010", name: "Коллектор с расходомерами Rommer 1\"x10 вых.", price: 13007, brand: "ROMMER" } },
        { id: "SMS-0917-000011", loops: 11, price: 30864, rommer: { id: "RMS-1200-000011", name: "Коллектор с расходомерами Rommer 1\"x11 вых.", price: 14172, brand: "ROMMER" } },
        { id: "SMS-0917-000012", loops: 12, price: 33210, rommer: { id: "RMS-1200-000012", name: "Коллектор с расходомерами Rommer 1\"x12 вых.", price: 15337, brand: "ROMMER" } }
    ],
    parts: [
        ...
        { id: "SFC-0020-001622", name: "Евроконус 16x2.2", price: 381, rommer: { id: "RFC-0020-001622", name: "Евроконус Rommer 16x2.2", price: 250, brand: "ROMMER" } },
        { id: "SFA-0029-000016", name: "Фиксатор 90", price: 127 },
        { id: "SFC-0020-001620", name: "Евроконус 16x2.0", price: 376, rommer: { id: "RFC-0020-001620", name: "Евроконус Rommer 16x2.0", price: 250, brand: "ROMMER" } }
    ],
    mixing_units: [
        { id: "SDG-0120-001000", name: "Насосно-смесительный узел (без насоса)", price: 25684, rommer: { id: "RDG-0120-008100", name: "Насосно-смесительный узел Rommer с термоголовкой (без насоса)", price: 14227, brand: "ROMMER" } }
    ],
    ...
    groups_dn25: [
        { id: "SDG-0001-002501", name: "Группа насосная DN25 (Прямая)", price: 17535, rommer: { id: "RDG-1001-002501", name: "Насосная группа Rommer прямая 1\" (без насоса)", price: 9500, brand: "ROMMER" } },
        { id: "SDG-0002-002501", name: "Группа насосная DN25 (Смес.)", price: 31942, rommer: { id: "RDG-1003-012501", name: "Насосная группа Rommer с 3-х ход. смесителем 1\"", price: 11270, brand: "ROMMER" } }
    ],
    ...
    hydro_dn25: [
        { id: "SDG-0018-004002", name: "Коллектор-гидрострелка DN25 (2 конт)", price: 56826, rommer: { id: "RDG-0017-004002", name: "Сборка: Коллектор + Гидрострелка Rommer 1 1/4\" (2 контура)", price: 21500, brand: "ROMMER" } },
        { id: "SDG-0018-004003", name: "Коллектор-гидрострелка DN25 (3 конт)", price: 64925, rommer: { id: "RDG-0017-004003", name: "Сборка: Коллектор + Гидрострелка Rommer 1 1/4\" (3 контура)", price: 27166, brand: "ROMMER" } }
    ],
    pumps_dn20: [{ id: "RCP-0002-1560130", brand: "ROMMER", name: "Насос 15/60-130", price: 3364 }],
    pumps_dn25: [
        { id: "SPC-0011-2560180", name: "Насос циркуляционный 25/60-180", price: 11669, type: 'default', desc: "Базовый насос STOUT 25/60-180.", rommer: { id: "RCP-0030-2560180", name: "Насос частотный Rommer PROFI EVO 25/60-180", price: 8930, brand: "ROMMER" } },
        { id: "SPC-0010-2560180", name: "Насос циркуляционный 25/60-180 (Std)", price: 11669, type: 'std', desc: "Классический 3-х скоростной насос.", rommer: { id: "RCP-0030-2560180", name: "Насос частотный Rommer PROFI EVO 25/60-180", price: 8930, brand: "ROMMER" } },
        { id: "SPC-0002-2560180", name: "Насос циркуляционный Mini 25/60-180", price: 21680, type: 'mini', desc: "Энергоэффективный (частотный).", rommer: { id: "RCP-0030-2560180", name: "Насос частотный Rommer PROFI EVO 25/60-180", price: 8930, brand: "ROMMER" } },
        { id: "SPC-0003-2560180", name: "Насос циркуляционный Mini Pro 25/60-180", price: 30622, type: 'pro', desc: "Премиум Smart (дисплей, авто-адаптация).", rommer: { id: "RCP-0030-2560180", name: "Насос частотный Rommer PROFI EVO 25/60-180", price: 8930, brand: "ROMMER" } }
    ],
    ...
    ball_valve_34: { id: "SVB-0004-000020", name: "Кран шаровой ВР/НР, 3/4\"", price: 1090, rommer: { id: "RBV-0004-0210220", name: "Шаровой кран Rommer 3/4\" ВН/НР (бабочка)", price: 480, brand: "ROMMER" } },
    check_valve_34: { id: "SVC-0011-000020", name: "Клапан обратный пружинный 3/4\"", price: 1446 },
    filter_mag: { id: "SFW-0072-000020", name: "Фильтр-шламоотделитель магнитный 3/4\"", price: 7720, rommer: { id: "RFW-0072-000020", name: "Фильтр-шламоотделитель магнитный Rommer 3/4\"", price: 4800, brand: "ROMMER" } },
    ...
    well_parts: [
        ...
        { id: "SVC-0011-000032", name: "Клапан обратный с металлическим седлом, 1 1/4\"", price: 3288, brand: "STOUT", unit: "шт", rommer: { id: "RVC-0011-000032", name: "Клапан обратный с металлическим седлом Rommer 1 1/4\"", price: 1650, brand: "ROMMER" } },
    ...
    well_auto: [
        { id: "SCS-0001-000070", name: "Блок управления насосом SIRIO UNIVERSAL", price: 38236, brand: "STOUT", unit: "шт", rommer: { id: "RCS-0001-000063", name: "Устройство управления насосом Rommer EPC-12 auto", price: 5880, brand: "ROMMER" } },
    ...
    water_pipes: [
        { id: "SPX-0001-001622", name: "Труба PEX-a 16x2.2 (серая)", price: 175, unit: "м", rommer: { id: "RPX-0001-001622", name: "Труба PEX-a Rommer 16x2.2", price: 110, brand: "ROMMER" } },
        { id: "SPX-0001-002028", name: "Труба PEX-a 20x2.8 (серая)", price: 262, unit: "м", rommer: { id: "RPX-0001-002028", name: "Труба PEX-a Rommer 20x2.8", price: 180, brand: "ROMMER" } },
        { id: "SPX-0001-002535", name: "Труба PEX-a 25x3.5 (серая)", price: 407, unit: "м", rommer: { id: "RPX-0001-002535", name: "Труба PEX-a Rommer 25x3.5", price: 280, brand: "ROMMER" } },
        { id: "SPX-0001-003244", name: "Труба PEX-a 32x4.4 (серая)", price: 661, unit: "м", rommer: { id: "RPX-0001-003244", name: "Труба PEX-a Rommer 32x4.4", price: 450, brand: "ROMMER" } }
    ],
    water_insulation: [
    ...
    water_parts: [
        ...
        { id: "SFA-0020-000016", name: "Гильза монтажная 16 (аксиальная)", price: 109, brand: "STOUT", rommer: { id: "RFC-1021-001620", name: "Фитинг компрессионный Rommer 16х2.0х3/4\"", price: 236, brand: "ROMMER" } }
    ]
};
